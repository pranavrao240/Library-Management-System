...
<html lang="en">
    ...
    <body class="sb-nav-fixed">
        ...
        <nav class="sb-topnav navbar navbar-expand navbar-dark bg-dark">
            <!-- Navbar Brand-->
            <a class="navbar-brand ps-3" href="UserIndex.jsp">Welcome</a>
            <!-- Sidebar Toggle-->
                            ...
                            <div class="card-body">
                                <table id="datatablesSimple">
                                    ...
                                    try{
                                    	...
                                    	PreparedStatement ps4 = con.prepareStatement("Select * from library_book where lno= '"+549+"' ");
